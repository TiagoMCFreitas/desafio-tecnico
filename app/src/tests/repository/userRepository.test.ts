...
describe("UserRepository", () => {
    ...
    describe("findAllUsers", () => {
        ...
        it("should throw error if findMany fails", async () => {
            (prisma.users.findMany as jest.Mock).mockRejectedValue(new Error("DB error"));
    ...
    describe("findUserByEmail", () => {
        it("should return user by email", async () => {
            const mockUser = { id: 1, name: "Alice", email: "alice@test.com", role: "admin", password: "hashed" };
        ...
        it("should throw error if findUnique fails", async () => {
            ...
            await expect(userRepository.findUserByEmail("alice@test.com")).rejects.toThrow("DB error");
        });
    });
    ...
    describe("updateUser", () => {
        it("should update user fields", async () => {
            ...
            const result = await userRepository.updateUser(1, "alice@test.com", "Alice", "admin");
        ...
        it("should update only provided fields", async () => {
            const mockUser = { id: 1, name: "Bob", email: "bob@test.com", role: "user", password: "hashed" };
            (prisma.users.update as jest.Mock).mockResolvedValue(mockUser);
        ...
        it("should throw error if update fails", async () => {
            ...
            await expect(userRepository.updateUser(1, "alice@test.com")).rejects.toThrow("DB error");
        });
    });

    describe("createUser", () => {
        it("should create a new user", async () => {
            const mockUser = { id: 2, name: "Bob", email: "bob@test.com", role: "user", password: "hashed" };
            (prisma.users.create as jest.Mock).mockResolvedValue(mockUser);

            const result = await userRepository.createUser("bob@test.com", "Bob", "hashed", "user");
        ...
        it("should throw error if create fails", async () => {
            (prisma.users.create as jest.Mock).mockRejectedValue(new Error("DB error"));
            await expect(userRepository.createUser("bob@test.com", "Bob", "hashed", "user")).rejects.toThrow("DB error");
        });
    });
});